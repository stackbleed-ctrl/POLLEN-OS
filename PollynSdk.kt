package com.stackbleedctrl.pollyn.sdk

import com.stackbleedctrl.pollyn.core.model.BrainDecision
import com.stackbleedctrl.pollyn.oslayer.BrainEvent
import com.stackbleedctrl.pollyn.oslayer.BrainEventBus
...
@Singleton
class PollynSdk @Inject constructor(
    ...
    suspend fun submitIntent(raw: String) {
        bus.emit(BrainEvent.InputEvent(com.stackbleedctrl.pollyn.core.model.PhoneEvent.UserIntent(raw)))
    }
